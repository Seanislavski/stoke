...
export default async function ChannelPage({
  ...
  let messagesQuery = admin
    .from('messages')
    .select('id, content, image_url, created_at, edited_at, previous_content, reply_to_id, author_id, deleted_at, deleted_by, profiles!author_id(username, display_name, avatar_url)')
