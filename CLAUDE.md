...
- **Run BOTH reviews migrations** in Supabase (`gzssbicdblkmllutegju`), in order: `20260623000000_reviews.sql` (base table) then `20260623120000_review_replies_ordering.sql` (reply + featured_position ALTERs). Reviews feature + management are deployed but inert until both run.
